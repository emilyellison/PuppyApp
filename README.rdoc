...
Here is an example of formatting our 'Submit' as a blue button with form_for:
...
That's it! You've gotten rid of an ugly checkbox. The only problem is 
with this format, a user doesn't know if the checkbox (or now - button)
has been selected or not. To fix this, we need to add some jQuery.
